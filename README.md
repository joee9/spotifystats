...
- `yearly_recap.py`: this creates a yearly recap of the user's top 20 songs, as well as the top ten songs from each month of the given year. This is backed up to the user's `gd_path` and not sent to them via email.
